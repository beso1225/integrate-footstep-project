...
class IntegrationFilesTest(unittest.TestCase):
    ...
    def test_tracker_enables_indoor_emotion_by_default(self):
        ...
        self.assertIn("from .emotion import (", runtime_module)
        self.assertIn("get_cached_indoor_emotion", runtime_module)
        self.assertIn("predict_indoor_emotion", runtime_module)
        self.assertIn("setup_indoor_emotion", runtime_module)
        ...
        self.assertIn("def get_cached_indoor_emotion(track_id):", emotion_module)
        ...
        self.assertIn("load_calibration_points", runtime_module)
        self.assertIn("calibration_points = load_calibration_points(GRID_CONFIG_PATH)", runtime_module)
        self.assertIn("create_calibration_state(grid_definition, calibration_points)", runtime_module)
        self.assertIn("save_grid_definition(grid_definition, GRID_CONFIG_PATH, calibration_state.points)", runtime_module)
